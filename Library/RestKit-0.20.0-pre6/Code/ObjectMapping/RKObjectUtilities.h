...
/**
 ...
 KVC Scalar/Structure support: http://developer.apple.com/library/ios/#documentation/cocoa/conceptual/KeyValueCoding/Articles/DataTypes.html#//appleref/doc/uid/20002171-BAJEAIEE
...
/**
 Returns an appropriate class to use for KVC access based on the output obtained via the `propertygetAttributes` reflection API.
...
/**
 Returns the name of a property when provided the name of a property obtained via the `propertygetAttributes` reflection API.
