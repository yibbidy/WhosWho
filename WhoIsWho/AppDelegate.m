...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
 ...
 //   RKObjectManager* manager = [RKObjectManager objectManagerWithBaseURL: @"http://localhost:3000"];
  //  manager.objectStore = [RKManagedObjectStore objectStoreWithStoreFilename:@"whoiswho.sqlite"];
    
    
    //manager.objectStore.managedObjectCache = [[DBManagedObjectCache new] autorelease];
